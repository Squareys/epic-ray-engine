 ...
 * Abstract Joypad
 * 
 * Class for KeyboardInputAbstraction. Uses Singleton model, so keep in mind
 * when deriving!
 * 
 * @author Squareys
 * 
...
public abstract class AbstractJoypad implements AWTEventListener {
	...
	/**
	 * Returns true, if keyCode is used in Joypad Faster than
	 * (findKeyIndex(keyCode) == -1)
	 * 
	 * @param keyCode
	 * @return
	 */
	...
	/**
	 * Returns the array index of the given keyCode. Returns -1 if keyCode was
	 * not found.
	 * 
	 * @param keyCode
	 * @return
